...
class HelpCenterController extends Controller
{
    ...
    public function store(HelpCenterRequest $request)
    {
        ...
        try {
            ...
            return Helpers::returnJsonResponse(config('constants.RECORD_CREATED'), Response::HTTP_CREATED, new HelpCenterResource($data));
        } catch (\Throwable $th) {
            DB::rollBack();
    ...
    {
        return Helpers::returnJsonResponse(config('constants.RECORD_INFO'), Response::HTTP_OK, new HelpCenterResource($help_center));
    }
    ...
    public function update(HelpCenterRequest $request, string $id)
    {
        ...
        try {
            ...
            return Helpers::returnJsonResponse(config('constants.RECORD_UPDATED'), Response::HTTP_ACCEPTED, new HelpCenterResource($help_center));
        } catch (\Throwable $th) {
            DB::rollBack();
            return Helpers::returnJsonResponse(config('constants.RECORD_ERROR'), Response::HTTP_INTERNAL_SERVER_ERROR);
        }
